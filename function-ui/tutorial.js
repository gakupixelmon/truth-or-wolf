...
export function createTutorial({ state, views, render }) {
  ...
  function bindEvents() {
    ...
    document.querySelector("#tutorial-play-real")?.addEventListener("click", () => { state.tutorialMode = false; state.tutorialRole = null; state.game = null; state.room = null; state.myFunction = null; state.myCondition = null; state.myRole = null; state.wolfFunctionOptions = null; state.showWolfFunctionList = false; state.error = null; render(); });
    document.querySelector("#tutorial-back-start")?.addEventListener("click", () => { state.tutorialMode = false; state.tutorialRole = null; state.game = null; state.room = null; state.myFunction = null; state.myCondition = null; state.myRole = null; state.wolfFunctionOptions = null; state.showWolfFunctionList = false; state.error = null; render(); });
